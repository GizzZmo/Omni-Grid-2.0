...
import { Ghost, PlusCircle, X, Scan, FileJson, BrainCircuit, Activity, Code2, Lock, Palette, Clock, Music, Calculator, TrendingUp, Languages, PenTool, Cloud, DollarSign, Terminal, HelpCircle, PenTool as PenToolIcon, Wand2, Radio, Grid } from 'lucide-react';
    ...
    <div className="h-full w-full relative group overflow-hidden bg-slate-900/40 backdrop-blur-sm border border-cyan-500/30 rounded-lg flex flex-col shadow-[0_0_20px_rgba(6,182,212,0.1)]">
       ...
       <div className="flex-1 flex flex-col items-center justify-center p-4 text-center z-10 gap-3">
           ...
           <div className="relative group-hover:scale-110 transition-transform duration-500">
                ...
                <SuggestedIcon size={48} className="text-cyan-300 relative z-10 drop-shadow-[0_0_10px_rgba(6,182,212,0.5)]" />
           </div>
           ...
           <div className="h-12 w-full max-w-[90%] flex items-center justify-center bg-black/20 rounded p-1 border border-white/5">
               <p className="text-[10px] text-slate-400 font-mono leading-tight">
                   {typedReason}<span className="animate-blink text-cyan-400">_</span>
               </p>
           </div>
