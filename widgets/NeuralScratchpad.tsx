...
export const NeuralScratchpad: React.FC = () => {
  ...
  return (
    <div className="h-full flex flex-col relative" onMouseLeave={() => setMenuPos(null)}>
      ...
      {menuPos && (
        ...
        >
          ...
          <button
            ...
            className="text-left text-xs px-2 py-1.5 hover:bg-fuchsia-900/50 text-slate-200 rounded flex items-center gap-2"
            role="menuitem"
          >
          ...
          <button
            ...
            role="menuitem"
          >
            <MessageSquare size={10} /> Cyberpunk Tone
          </button>
          <button
      ...
      {/* Toolbar */}
      <div
        className="flex gap-2 mb-2 overflow-x-auto pb-1 custom-scrollbar"
        role="toolbar"
      ...
      {loading && (
        <div
          className="absolute bottom-2 right-2 bg-slate-900/90 border border-slate-700 text-fuchsia-400 text-xs px-2 py-1 rounded flex items-center gap-2 shadow-lg z-10 animate-pulse"
          role="status"
        >
      ...
      {error && (
        <div
          className="absolute bottom-2 right-2 bg-red-900/90 border border-red-700 text-white text-xs px-2 py-1 rounded shadow-lg z-10"
          role="alert"
        >
          {error}
        </div>
