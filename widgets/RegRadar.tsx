      ...
      <div className="flex-1 overflow-y-auto custom-scrollbar flex flex-col gap-2">
        <div className="bg-slate-900/50 p-2 rounded border border-l-2 border-slate-800 border-l-red-500">
          ...
          <p className="text-[10px] text-slate-500 leading-tight">
            Enforcement actions targeting non-custodial wallets increasing. Focus on
            &quot;dealer&quot; definitions.
          </p>
        </div>
        ...
        <div className="bg-slate-900/50 p-2 rounded border border-l-2 border-slate-800 border-l-emerald-500">
          <div className="flex justify-between items-start mb-1">
            ...
            <span className="text-[8px] bg-emerald-900/30 text-emerald-400 px-1 rounded">
              STABLE
            </span>
          </div>
          <p className="text-[10px] text-slate-500 leading-tight">
            Full implementation timeline clarified. Stablecoin issuers (USDT) face strict reserve
            audits.
          </p>
        </div>
        ...
        <div className="bg-slate-900/50 p-2 rounded border border-l-2 border-slate-800 border-l-blue-500">
          ...
          <p className="text-[10px] text-slate-500 leading-tight">
            Market structure bill passing house signals bipartisan support for clear asset
            classification.
          </p>
        </div>
      </div>
