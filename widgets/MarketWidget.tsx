    ...
    <div className="h-full flex flex-col gap-3">
      ...
      <div className="p-2 border-b border-slate-800 bg-slate-900/50 flex justify-between items-center backdrop-blur-sm rounded-t-lg">
        <div className="flex items-center gap-2">
          ...
          <div>
            <h2 className="font-bold text-xs text-slate-200 leading-tight uppercase">
              Market Watch
            </h2>
            ...
            {loading && data.length === 0
              ? // Skeleton Loading
                [...Array(6)].map((_, i) => (
                  <div
                    key={i}
                    className="flex items-center justify-between p-2 animate-pulse bg-slate-900/30 rounded border border-white/5"
                  >
                    <div className="flex items-center gap-2">
