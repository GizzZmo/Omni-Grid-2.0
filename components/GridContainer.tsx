    ...
    () => ({
      ...
      STRATEGIC: (
        <WidgetShell
          ...
          className="h-full"
        >
          <Lazy label="STRATEGIC BLUEPRINT">
            <StrategicBlueprint />
          </Lazy>
        </WidgetShell>
      ),
